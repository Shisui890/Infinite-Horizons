...
export class AITemporalService {
  ...
  public static async createUniverseFromTopic(
    ...
    const fallbackEvents: Array<Partial<TemporalEvent> & { causes?: string[] }> = [
      {
        title: `Fundamentos Matemáticos: ${topic}`,
        description: `Formulação das equações diferenciais fundamentais e métrica de espaço-tempo que descrevem o sistema associado a ${topic}.`,
        year: 1915,
        category: 'FÍSICA TEÓRICA',
        importance: 95,
      ...
      {
        title: `Primeira Verificação em Periódico: ${topic}`,
        description: `Publicação seminal contendo o modelo físico e análise de autoconsistência com base em princípios de simetria.`,
        year: 1965,
        category: 'MECÂNICA QUÂNTICA',
        importance: 90,
        sourceUrl: 'https://journals.aps.org/pr/abstract/10.1103/PhysRev.140.B1110',
        evidenceKind: 'scientific_theory',
        evidenceConfidence: 90,
        causes: ['generated-0'],
      },
      {
        title: `Correspondência Holográfica & Teoria de Cordas`,
        description: `Integração de ${topic} com a teoria quântica de campos e variedades compactas de Calabi-Yau.`,
        year: 1997,
      ...
      },
      {
        ...
        description: `Detecção de assinaturas métricas compatíveis com o modelo por meio de observatórios interferométricos e telescópios espaciais.`,
        year: 2019,
        category: 'OBSERVAÇÃO',
        importance: 96,
